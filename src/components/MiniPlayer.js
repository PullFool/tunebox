  ...
  return (
    <TouchableOpacity style={styles.container} onPress={() => setShowNowPlaying(true)} activeOpacity={0.9}>
      <View style={styles.art}>
        {currentSong.cover ? (
          <Image source={{ uri: currentSong.cover }} style={styles.artImg} />
        ) : (
...
const styles = StyleSheet.create({
  container: {
    ...
    paddingHorizontal: 12, paddingVertical: 8, borderTopWidth: 1, borderTopColor: '#333',
  },
  art: {
    width: 42, height: 42, borderRadius: 6, backgroundColor: '#1a1a1a',
